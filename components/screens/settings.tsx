...
export default function ChartScreen() {
  ...
  return (
    ...
    >
      <Text style={styles.heading}>Native Swift Charts with Styling</Text>
      ...
      <View style={styles.settingsContainer}>
        <Text style={styles.settings}>
          ...
          {legendIndex === 1 ? "ON" : "OFF"}
        </Text>
      </View>
      <Text style={styles.controlHeading}>Chart Type</Text>
      ...
      <Text style={styles.controlHeading}>Data Set</Text>
      <View style={styles.pickerContainer}>
        <Host matchContents>
          <Picker
      ...
      {(chartType === "line" || chartType === "point") && (
        <>
          <Text style={styles.controlHeading}>
      ...
      {chartType === "bar" && (
        <>
          <Text style={styles.controlHeading}>Bar Styling</Text>
      ...
      {chartType === "pie" && (
        <>
          <Text style={styles.controlHeading}>Pie Styling</Text>
      ...
      <Text style={styles.controlHeading}>Options</Text>
